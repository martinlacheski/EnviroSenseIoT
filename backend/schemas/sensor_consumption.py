### ConsumptionSensor schema ###


def consumption_sensor_schema(sensor) -> dict:
    return {
...
def consumption_sensors_schema(sensors) -> list:
    return [consumption_sensor_schema(sensor) for sensor in sensors]
