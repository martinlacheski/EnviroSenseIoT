...
export const Ciudades = () => {
  ...
  const columns: TableColumn<DataRow>[] = [
    ...
    {
      name: "CÓDIGO POSTAL",
      selector: (row: DataRow) => row.postal_code,
    },
    {
      name: "PROVINCIA",
      selector: (row: DataRow) => row.province.name,
    },
    {
      name: "PAIS",
      selector: (row: DataRow) => row.province.country.name,
    },
    {
      name: "ACCIONES",
      center: true,
    ...
    <Fragment>
      ...
      <Modal show={isModalOpen} onHide={handleHide}>
        <Modal.Header closeButton>
          <Modal.Title>
            {editingId ? `Modificar ciudad` : `Crear ciudad`}
          </Modal.Title>
        </Modal.Header>
        ...
        <Formik
          ...
          validationSchema={Yup.object({
            ...
            postal_code: Yup.string().required("Este campo es obligatorio"),
            ...
            <Form id="form">
              <Modal.Body className="d-flex flex-column gap-2">
                ...
                <CustomInput.Text
                  ...
                  name="postal_code"
                  type="text"
                  placeholder="Código postal de la ciudad"
                  isInvalid={!!errors.name && touched.name}
                />
              </Modal.Body>
