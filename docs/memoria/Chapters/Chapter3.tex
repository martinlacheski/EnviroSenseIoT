...
% El procesamiento y la gestión de datos se realizó a través de un backend
% desarrollado con FastAPI, mientras que la base de datos MongoDB se utilizó para
% el almacenamiento de la información. Además, se implementó una interfaz de
% usuario en React para la visualización y gestión de los datos.
...
% \subsubsection{Creación del Objeto Thing y certificados de seguridad en AWS IoT Core}

% A continuación, se describen los pasos realizados en AWS IoT Core para crear y
% configurar el objeto \textit{Thing} y los certificados de seguridad necesarios
% para establecer una conexión segura con el broker MQTT:
...
% \subsubsection{Políticas de acceso en AWS IoT Core}

% Las políticas de acceso determinan los permisos del cliente para publicar,
...
Los reportes consumen los datos procesados a través de la API del backend, lo
