...
% Además, se simularon condiciones cercanas a las reales de operación, lo que
% facilitó la evaluación del comportamiento general del sistema.
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=\textwidth]{Images/40_websocket_1.png}
...
La figura \ref{fig:websocket_2} permite visualizar las conexiones WebSocket
...
La figura \ref{fig:mongodb_2} muestra la interfaz de MongoDB Compass, donde se
